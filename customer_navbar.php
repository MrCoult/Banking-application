...
<body>
    <div class="nav-wrapper">
        <div class="topnav" id="theTopNav">
            ...
            <a id="user">Bun venit, &nbsp<?php echo $row["first_name"]; ?> !</a>
            <a id="logout" href="./logout_action.php" onclick="return confirm('Ești sigur că vrei să ieși din cont?')">Ieși din cont</a>
            <a id="profile" href="./customer_profile.php">Profilul meu</a>
        </div>
    </div>
