...
<body>
    <div class="search-bar-wrapper">
        <div class="search-bar" id="the-search-bar">
            ...
            <a class="add-button" href="rapoarte/ex6.php">Raport listă de clienți ai băncii</a>

                <form class="search_form" action="" method="post">
                    <div class="flex-item-search">
                        <input name="search" size="30" type="text" placeholder="Caută client" />
                    </div>
            ...
            while($row = $result->fetch_assoc()) {
                ...
                <div class="flex-item">
                    ...
                    <div class="flex-item-2">
                        ...
                        <p id="acno"><?php echo "IBAN : " . $row["account_no"]; ?></p>
                    </div>
                    <div class="flex-item-1">
                        <div class="dropdown">
                          ...
                          <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                            <a href="./edit_customer.php?cust_id=<?php echo $row["cust_id"] ?>">Vezi / Editează</a>
                            <a href="./transactions.php?cust_id=<?php echo $row["cust_id"] ?>">Tranzacții</a>
                            <a href="./office_simulator.php?cust_id=<?php echo $row["cust_id"] ?>">Operații</a>

                            <a href="./delete_customer.php?cust_id=<?php echo $row["cust_id"] ?>"
                                 onclick="return confirm('Ești sigur că vrei să faci asta?')">Șterge</a>
                          </div>
                        </div>
                    </div>
                </div>
