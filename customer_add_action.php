    ...
    <div class="flex-container">
        <div class="flex-item">
            ...
            if (($conn->query($sql3) === TRUE)) { ?>
                <p id="info"><?php echo "Clientul a fost adăugat cu succes !\n"; ?></p>
        </div>

        <div class="flex-item">
            <?php
            if (($conn->query($sql1) === TRUE)) { ?>
                <p id="info"><?php echo "IBAN deschis cu succes !\n"; ?></p>
            <?php
            } else { ?>
                <p id="info"><?php
                echo "Eroare: " . $sql1 . "<br>" . $conn->error . "<br>"; ?></p>
            <?php } ?>
        </div>
        ...
        <div class="flex-item">
            ...
            if (($conn->query($sql4) === TRUE)) { ?>
                <p id="info"><?php echo "IBAN actualizat su succes !\n"; ?></p>
            <?php
            } else { ?>
                <p id="info"><?php
                echo "Eroare: " . $sql4 . "<br>" . $conn->error . "<br>"; ?></p>
            <?php } ?>
        </div>
        ...
        <div class="flex-item">
            ...
            if (($conn->query($sql2) === TRUE)) { ?>
                <p id="info"><?php echo "Lista cu prieteni creată cu succes !\n"; ?></p>
            <?php
            } else { ?>
                <p id="info"><?php
                echo "Eroare: " . $sql2 . "<br>" . $conn->error . "<br>"; ?></p>
            <?php } ?>
        </div>
        ...
        <div class="flex-item">
                <p id="info"><?php
                echo "Eroare: " . $sql3 . "<br>" . $conn->error . "<br>"; ?></p>
            <?php } ?>
        </div>
        <?php $conn->close(); ?>

        <div class="flex-item">
            <a href="./customer_add.php" class="button">Adaugă din nou</a>
        </div>
