...
<body>
    <div class="sidenav" id="theSideNav">
        ...
        <a href="./customer_home.php">Acasă</a>
        <a href="./customer_transactions.php">Listă tranzacții</a>
        <a href="./beneficiary.php">Transferă bani</a>
        <a href="./atm_simulator.php">Bancomat</a>
