<?php
    ...
    if (!empty($_SESSION['search_term'])) {
        ...
        if (!empty($_SESSION['date_from']) && empty($_SESSION['date_to'])) {
            ...
            $filter_indicator = "Mențiune și dată";
        }
        if (empty($_SESSION['date_from']) && !empty($_SESSION['date_to'])) {
        ...
        if (!empty($_SESSION['date_from']) && !empty($_SESSION['date_to'])) {
            ...
            $filter_indicator = "Mențiune și date";
        }
    }
            ...
            <div class="flex-item-search-bar" id="fi-search-bar">
                ...
                <div class="flex-item-search-by">
                    <select name="by" onChange="window.location.href=this.value">
                        ...
                        <option value="customer_transactions.php?sort=date_down">Dată &darr;</option>
                        <option value="customer_transactions.php?sort=date_up">Dată &uarr;</option>
                    </select>
                </div>
    ...
    <div id="id01" class="modal">
      ...
      <form class="modal-content animate" action="" method="post">
        ...
        <div class="container">
            ...
            <p id="filter">(Lasă gol pentru a șterge filtru)</p>
          <label>Mențiuni :</label>
          <input type="text" placeholder="Introdu mențiune" name="search_term">
...
<form class="modal-content animate" action="rapoarte/ex1.php" method="post">
  <div class="imgcontainer">
  ...
  <div class="container">
    ...
    <div class="flex-container">
        <p id="none">Filtrează : <?php echo $filter_indicator ?></p>
    </div>
    ...
    <div class="flex-container">
        ...
        <?php
            ...
            <?php
                ...
                <p id="none"> Nu s-au găsit rezultate!</p>
            <?php }
            $conn->close(); ?>
