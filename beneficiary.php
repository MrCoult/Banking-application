...
<body>
    <div class="search-bar-wrapper">
        <div class="search-bar" id="the-search-bar">
            <div class="flex-item-search-bar" id="fi-search-bar">
                <a class="add-button" href="./add_beneficiary.php">Adaugă prieten</a>
                <a class="add-button" href="rapoarte/ex2.php">Raport listă de prieteni</a>

                <form class="search_form" action="" method="post">
                    <div class="flex-item-search">
                        <input name="search" size="30" type="text" placeholder="Caută prieten" />
                    </div>
    ...
    <div class="flex-container">
        <p id="info">Trimite, Adaugă/Șterge prieten.</p>
        <?php
                ...
                ?>
                    ...
                    <div class="flex-item">
                        ...
                        <div class="flex-item-2">
                            ...
                            <p id="acno"><?php echo "IBAN : " . $row1["account_no"]; ?></p>
                        </div>
                        <div class="flex-item-1">
                            <div class="dropdown">
                              ...
                              <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                                    <a href="./send_funds.php?cust_id=<?php echo $row1["cust_id"] ?>">Trimite</a>
            ...
            if ($isBenefPresent == 0) { ?>
                <p id="none"> Pentru a face un transfer trebuie să asociezi un IBAN contului tău</p>
            <?php }
            if ($back_button) { ?>
