...
<body>
    <div class="flex-container">
        <div class="flex-item">
            <?php
            if ($err_no == -1) { ?>
                <p id="info"><?php echo "Eroare la conectare ! Incearcă din nou.\n"; ?></p>
            <?php } ?>

            <?php
            if ($err_no == 0) { ?>
                <p id="info"><?php echo $info_string." schimbată cu succes !\n"; ?></p>
            <?php } ?>

            <?php
            if ($err_no == 1) { ?>
                <p id="info"><?php echo "Vechea ".$info_string." este incorectă !\n"; ?></p>
            <?php } ?>

            <?php
            if ($err_no == 2) { ?>
                <p id="info"><?php echo $info_string." nu se potrivesc !\n"; ?></p>
            <?php } ?>

            <?php
            if ($err_no == 3) { ?>
                <p id="info"><?php echo "Vechea și noua ".$info_string." sunt la fel !\n"; ?></p>
            <?php } ?>
        </div>
