    ...
    <div class="flex-container">
        <div class="flex-item">
            ...
            if (($conn->query($sql0) === TRUE) && ($conn->query($sql1) === TRUE)) { ?>
                <p id="info"><?php echo "Notificarea a fost trimisă cu succes !\n"; ?></p>
            <?php
            } else { ?>
                <p id="info"><?php
                echo "Eroare la conexiune !<br>";
                echo "Eroare: " . $sql0 . "<br>" . $conn->error . "<br>";
        ...
        <div class="flex-item">
            <a href="post_news.php" class="button">Trimite altă notificare</a>
        </div>
