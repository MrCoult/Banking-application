...
if (isset($_SESSION['loggedIn_cust_id'])) {
	$sql0 = "SELECT trans_id as 'ID',trans_date as 'Data',remarks as 'MENTIUNE', debit as 'DEBIT', credit as 'CREDIT',balance as 'BALANTA' FROM passbook".$_SESSION['loggedIn_cust_id'];
}
