...
<body>
    <div class="sidenav" id="theSideNav">
        ...
        <a href="./admin_home.php">Acasă</a>
        <a id="label">Meniu principal</a>
        <a href="./customer_add.php">Adaugă client</a>
        <a href="./manage_customers.php">Listă clienți</a>
        <a href="./post_news.php">Notificări</a>
    </div>
